...
# Guía para Migrar a Pro 7.2

<head>
  <title>Migración a Pro 7.2</title>
  <meta
    name="description"
...
Ingresamos el número del servicio y la contraseña root de la base de datos.

En la carpeta root como `{dominio}.txt` o en el archivo `.env` se encuentra la contraseña root de la base de datos.
