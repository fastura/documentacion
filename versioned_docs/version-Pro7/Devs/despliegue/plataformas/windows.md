...
Antes de instalar, tenga en cuenta que existen dos versiones del facturador: **Pro7.2** y **ProX**, cada una con sus propios requisitos.
...
4. Edite el archivo `.env` y modifique estas variables:
   ...
   _Reemplace `pro8` por el nombre de su carpeta y `.test` según su configuración de Hostname_

   ```env
   DB_DATABASE=nombre_de_su_base_de_datos
   ```

   _Ingrese el nombre de la base de datos creada en el Paso 3_
...
_Sistema de Facturación Pro 7.2_
